...
public class Golf : MonoBehaviour
{
    ...
    void LayoutMine()
    {
        ...
        foreach (JsonLayoutSlot slot in jsonLayout.slots)
        {
            ...
            cp.layoutID = slot.id;
            cp.layoutSlot = slot;
            // CardGolf in the mine have the state CardState.mine
    ...
    void GameOver(bool won)
    {
        ...
        CardSpritesSO.RESET();                                                // b
                                                                              ...
                                                                              // Note that there are TWO underscores at the beginning of "__Golf…
    ...
    static public void CARD_CLICKED(CardGolf cp)
    {
        ...
        switch (cp.state)
        {
            ...
            case eCardState.drawpile:
                ...
                // Call two methods on the Golf Singleton S
            ...
            case eCardState.mine:
                ...
                foreach (int coverID in cp.layoutSlot.hiddenBy)
                {
                    CardGolf coverCP = S.mineIdToCardDict[coverID];
